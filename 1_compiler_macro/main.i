...
int main() {
    ...
    int num_list[] = {1, 2, 54, 5, 6, 6, 7}; int args_len = sizeof(num_list)/sizeof(int); int result = num_list[0]; for(int index=1;index<args_len;index++) { result += num_list[index]; } printf("Sum [%s] = %d", "1, 2, 54, 5, 6, 6, 7", result);;
